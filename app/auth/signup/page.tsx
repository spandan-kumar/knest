...
export default function SignUp() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!email.toLowerCase().endsWith('@appointy.com')) {
      setError('Only @appointy.com email addresses are allowed');
      return;
    }
    ...
    <div className="min-h-screen bg-gray-950 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <p className="text-gray-400">Join the Appointy team on KNest</p>
        </div>
        ...
        <div className="bg-gray-900/50 backdrop-blur-sm border border-gray-800 rounded-2xl p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              />
              <p className="mt-1 text-xs text-gray-500">Only @appointy.com emails are allowed</p>
            </div>
